window.PETSTAY_CONFIG = {
  ...
  BOOKING_API_URL: 'https://https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//booking',
  BOOKING_STATUS_API_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//bookingStatus',
  BOOKINGS_API_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//bookings',
  ROOMS_AVAILABILITY_API_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//rooms/availability',
  NEW_BOOKING_API_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//newbooking',
  CONFIRM_BOOKING_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//confirm',
  CANCEL_BOOKING_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//cancel',
  CHECKIN_BOOKING_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//checkin',
  CHECKOUT_BOOKING_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//checkout',
  RESTORE_BOOKING_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//restore',
  PET_PHOTO_UPLOAD_URL: 'https://cz87cyx5k1.execute-api.us-east-1.amazonaws.com//upload-url',
  PET_PHOTO_PUBLIC_URL_BASE: 'https://petstay-pet-photos-101039238.s3.us-east-1.amazonaws.com',
 ...
 /* IOT_ENDPOINT: 'a14wno4fkns9pt-ats.iot.us-east-1.amazonaws.com',  // Your IoT endpoint
  ...
  IDENTITY_POOL_ID: 'us-east-1:25fbdcc1-9e3d-4655-adbf-679d2f895c0c',*/ //IOT is not developed yet
};
